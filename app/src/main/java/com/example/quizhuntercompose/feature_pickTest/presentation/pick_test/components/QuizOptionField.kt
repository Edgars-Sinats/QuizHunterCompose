...
//    allTopics: List<String>,
    ...
    onTopicsSelected: () -> Unit, //Drop down or just scrollable list view ?
    expanded: Boolean,
    ...
    Column (
        ...
        if (expanded1){
            ...
            Row(modifier.fillMaxWidth(),
                ...
                Switch(
                    checked = testOptionState.answerTime,
                    onCheckedChange = { testOptionState.answerTime = !it} )
            }
...
//            } , checkBoxText = "All topics")
                items(testOptionState.topics) { topic ->
                    CheckBoxRow(checkedState = false, onStateChange = { selectedTopics = listOf("1","2","Weary long text .......xxxx........ of topics") }, checkBoxText = topic)
                }
            }
        }
